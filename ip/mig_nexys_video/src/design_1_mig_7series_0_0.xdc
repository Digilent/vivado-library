...
create_clock -period 5 [get_ports clk_ref]          
...
set_property IOSTANDARD LVCMOS25 [get_ports {sys_clock}]
...
set_false_path -through [get_nets -hier -filter {NAME =~ *u_iodelay_ctrl/sys_rst*}]          
